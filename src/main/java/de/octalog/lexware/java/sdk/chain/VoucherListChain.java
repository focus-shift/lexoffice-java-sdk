...
import de.octalog.lexware.java.sdk.model.VoucherStatus;
import de.octalog.lexware.java.sdk.model.VoucherType;
...
public class VoucherListChain extends ExecutableRequestChain {
    ...
    private static final ParameterizedTypeReference<Page<Voucher>> TYPE_REFERENCE = new ParameterizedTypeReference<>() {
    };
    ...
    public VoucherListChain voucherDate(Date voucherDate) {
        super.getUriBuilder()
                .addParameter("voucherDate", LexwareApi.DATE_TIME_FORMAT.format(voucherDate));
        return this;
    }
    public VoucherListChain createdDate(Date createdDate) {
        super.getUriBuilder()
                .addParameter("createdDate", LexwareApi.DATE_TIME_FORMAT.format(createdDate));
        return this;
    }

    public VoucherListChain updatedDate(Date updatedDate) {
        super.getUriBuilder()
                .addParameter("updatedDate", LexwareApi.DATE_TIME_FORMAT.format(updatedDate));
        return this;
    }

    public VoucherListChain dueDate(Date dueDate) {
        super.getUriBuilder()
                .addParameter("dueDate", LexwareApi.DATE_TIME_FORMAT.format(dueDate));
        return this;
    }
